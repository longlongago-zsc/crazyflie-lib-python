...
class LogConfigReader():
    ...
    def __init__(self, crazyflie):
        ...
        if not os.path.exists(espDrone.config_path + "/log"):
            logger.info("No user config found, copying dist files")
            shutil.copytree(espDrone.module_path + "/configs/log", espDrone.config_path + "/log")
        self._cf = crazyflie
    ...
    def create_category(self):
        ...
        log_path = os.path.join(espDrone.config_path, 'log')
    ...
    def _get_log_path(self, category):
        ...
        return os.path.join(espDrone.config_path,
                            'log' + category_dir)
    ...
    def _get_configpaths_recursively(self):
        ...
        """
        logpath = os.path.join(espDrone.config_path, 'log')
        filepaths = []
